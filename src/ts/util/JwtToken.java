...
public class JwtToken {
    ...
    private static final String iss = "Ostrichcrab";
    ...
    public static String createJWT(String name, String userId, String audience) {
    	System.out.println("creatingJWT……"+"name:"+name+"userId:"+userId+"audience:"+audience);
        ...
        System.out.println("i am in 46……");
        //添加构成JWT的参
        JwtBuilder builder = Jwts.builder()
        		.setHeaderParam("typ", "JWT").setHeaderParam("alg", "HS256") //header
        ...
        //生成JWT
        System.out.println("creatingJwt is going to finish");
